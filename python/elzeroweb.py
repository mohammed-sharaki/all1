...
print( (dict(h)))
#print(dict(l))#دي مش بتتحول 


'''
#user input
fname=input("what is frist name ? : ")
mname=input("what is middle  name ? : ")
...
print(f"hello {fname} {mname} {lname} happy to see you ") #المسافات هنستخدم strip

#print(f"hello {fname} {mname} {lname} happy to see you ") 
'''
#==============slice emile================
email="maommedsharaki@gmail.com"
...
pname=100
sname=30
print(f"hello {uanme}\nthis is {cname} course\nand the price is ${pname-sname}")